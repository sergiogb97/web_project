...
<?php
	...
	/**
	  * Los datos de $divSOs que utiliza la vista luego se recogen en el modelo04 por medio de la funcion  mod004_getSOs().
	  *
	  * Creado por Sergio Garcia.
	  */
	$divSOs = mod004_getSOs();
	
	require ("vista/vista_tree.php");
?>